            ...
            __c(
                ...
                [
                    __c('p',{style:'font-size: .9rem;font-family:ubuntu;line-height: 1.75rem;text-align:center;font-weight:900;color:#fff;width:100vw'},[
                        '© 2024 All Right Reserved by GOAT'
                    ])
                ]
            )
        ]
    ...
    return __c(
        ...
        [
            __c(
                'div',
                {
                    style:`min-height:${__p(['navBar','l_size'],'120px')};min-width:${__p(['navBar','l_size'],'120px')};border-radius:50%;background-image:url('./assets/logo.jpg');background-color:#0276D7;border:5px groove #015498;`
                },[],{genericStyle:['bg_fit']}
            ),
            __c(
                'div',
                ...
                [
                    __SYD.nav_b_text('Who is GOAT?','_p3'),
